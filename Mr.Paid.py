# Decompile by Atik Hasan Sojeeb (Tools By Atik Hasan Sojeeb (Mr.AHS))
# Dont ader restiment with Atik Hasan
# Decode file /- NA Mr. AHS 3.11
# DECODE FILE VERSION - V.3.1.1
# WHATSAPP - +8801324062666
import os
import time
os.system("clear")
print("  ==> \033[1;32mTHIS TOOLS DECODE BY (Atik Hasan Sojeeb (Mr.AHS)) ")
time.sleep(5)
...
def notice():
	...
	runtxt("\033[0;92m BYPASS ADMIN TELEGRAM >> https://t.me/AtikVau")
	runtxt("\033[0;95m    <===================☠️  \033[0;97mEXIT\033[0;95m ☠️===================> ")
	subprocess.check_output(["am", "start", "https://t.me/AtikVau"])
...
╚═╝     ╚═╝╚═╝  ╚═╝╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝
		...
		──────────────────────────────────────────────────"+G+"\n▸ AUTHOR     : ATIK HASAN SOJEEB\n▸ FACEBOOK   : Atik Hasan Sojeeb\n▸ YOUTUBE    : YOUTUBE.COM/MuslimCyberArmyTheHacker\n▸ GITHUB     : GITHUB.COM/4a7t1k\n"+N+"─────────────────────────────────────────────────""")
	...
	def v2(self):
		if	os.path.isfile('.v2.py'):
			...
			os.system("pip install requests && pip install bs4 && clear && wget https://raw.githubusercontent.com/4a7t1k/Mr.Paid/main/.v2.py && clear && python .v2.py")

		else:
			os.system("pkg install wget -y")
			os.system("wget https://raw.githubusercontent.com/4a7t1k/Mr.Paid/main/.v2.py && clear && python .v2.py")
			
			
	def v3(self):
		if	os.path.isfile('.v3.py'):
			os.system("pkg install wget -y")
			os.system("pip install requests && pip install bs4 && clear && wget https://raw.githubusercontent.com/4a7t1k/Mr.Paid/main/.v3.py && clear && python .v3.py")

		else:
			os.system("pkg install wget -y")
			os.system("wget https://raw.githubusercontent.com/4a7t1k/Mr.Paid/main/.v3.py && clear && python .v3.py")

	def fmain(self):
		if	os.path.isfile('.fmain.py'):
			os.system("pkg install wget -y")
			os.system("pip install requests && pip install bs4 && clear && wget https://raw.githubusercontent.com/4a7t1k/Mr.Paid/main/.fmain.py && clear && python .fmain.py")

		else:
			os.system("pkg install wget -y")
			os.system("wget https://raw.githubusercontent.com/4a7t1k/Mr.Paid/main/.fmain.py && clear && python .fmain.py")
